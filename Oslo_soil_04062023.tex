...
\Title{Stabilization/solidification tests on dredged masses from Kongshavn, Oslo}

% MDPI internal command: Title for citation in the left column
\TitleCitation{Stabilization/solidification tests on dredged masses from Kongshavn, Oslo}
...
Preface
This report is a result report from laboratory tests carried out at the building materials department at LTH and tests carried out at the state's geotechnical institute (SGI). The assignment was carried out for Norconsult AS.
In connection with the start of this project, the choice was between dredged masses from Arendal and dredged masses from Kungshavn to be used in a research project run by SGI and financed by the Swedish Transport Administration. 
